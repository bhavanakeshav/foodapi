                    ...
                    <div className="col-md-7 col-lg-8">
                        ...
                        <form className="needs-validation" novalidate>
                            <div className="row g-3">
                                ...
                                <div className="col-12">
                                    <label htmlFor="phone" className="form-label">Phone Number <span className="text-body-secondary">(Optional)</span></label>
                                    <input type="tel" className="form-control" id="phone" placeholder="+1 1234567890" inputMode="numeric" autoComplete="tel" pattern="^\+?[0-9\s\-()]{7,20}$" />
                                </div>
                                ...
                                <div className="col-md-3">
                                    ...
                                    <input type="tel" className="form-control" id="zip" placeholder=" " required />
                                </div>
                            </div>
