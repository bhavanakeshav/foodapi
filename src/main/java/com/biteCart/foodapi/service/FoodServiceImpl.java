...
public class FoodServiceImpl implements FoodService{
    ...
    public String uploadFile(MultipartFile file) {
        ...
        try{
            ...
            if(response.sdkHttpResponse().isSuccessful()){
                ...
                throw new ResponseStatusException(HttpStatus.INTERNAL_SERVER_ERROR, "Failed to upload your file");
            }
    ...
    public FoodResponse readFood(String id) {
        FoodEntity existingFood = foodRepository.findById(id).orElseThrow(() -> new RuntimeException("Food not found for the requested id : " + id));
